      ...
      <div class="modal-caja modal-wider" (click)="$event.stopPropagation()">
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
          ...
          <div class="campo">
            ...
            <input id="rucC" class="input-auth" type="text" formControlName="ruc" placeholder="Ej: 20111222333" maxlength="20" />
            @if (form.controls['ruc'].invalid && form.controls['ruc'].touched) {
              <span class="error-text">RUC requerido (máximo 20 caracteres)</span>
            }
          </div>
          ...
          <div class="campo">
            ...
            <div class="upload-zone" (click)="fileInput.click()" [class.upload-zone--has-image]="photoPreviewUrl() || client?.photoUrl">
              <input
                #fileInput
                type="file"
                ...
                style="display: none;"
              />
              @if (photoPreviewUrl() || client?.photoUrl) {
                <div class="upload-preview">
                  <img [src]="photoPreviewUrl() || client!.photoUrl" alt="Preview" class="photo-preview" />
