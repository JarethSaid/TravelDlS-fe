  ...
  template: `
    <div class="dashboard">
      ...
      <div class="recent-trips">
        ...
        <div class="empty-state">No hay viajes registrados.</div>
      </div>
    </div>
  `,
  styles: `
...
export class DriverDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.currentDate =
      this.datePipe.transform(today, "EEEE, d 'de' MMMM yyyy", '', 'es-ES') ||
      this.datePipe.transform(today, "EEEE, d 'de' MMMM yyyy") ||
      '';
